    ...
    if results[0].boxes is not None and results[0].boxes.id is not None:
        ...
        for box, class_id, track_id, conf in zip(boxes, class_ids, track_ids, confidences):
            ...
            if result >= 0:
                ...
                # elif c == 'helmet':
                #     helmet_detected = True  # Mark that helmet is detected
                elif c == 'numberplate':
        ...
        # If both helmet and numberplate are detected and the track ID is not already processed
        # if helmet_detected and numberplate_box is not None and numberplate_track_id not in processed_track_ids:
        #     x1, y1, x2, y2 = numberplate_box
        #     crop = frame[y1:y2, x1:x2]
        #     crop = cv2.resize(crop, (120, 85))
